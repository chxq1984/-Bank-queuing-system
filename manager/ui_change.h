...
**
** Created: Sat Jul 13 07:13:46 2019
...
public:
    ...
    void setupUi(QDialog *change)
    {
        ...
        layoutWidget->setGeometry(QRect(70, 60, 411, 181));
        ...
        horizontalLayout_2->setStretch(2, 78);
        ...
        xinmimaqueren = new QLineEdit(layoutWidget);
        xinmimaqueren->setObjectName(QString::fromUtf8("xinmimaqueren"));

        horizontalLayout_4->addWidget(xinmimaqueren);
        ...
        layoutWidget_2 = new QWidget(change);
        layoutWidget_2->setObjectName(QString::fromUtf8("layoutWidget_2"));
        layoutWidget_2->setGeometry(QRect(70, 250, 411, 51));
        horizontalLayout_5 = new QHBoxLayout(layoutWidget_2);
        horizontalLayout_5->setObjectName(QString::fromUtf8("horizontalLayout_5"));
        horizontalLayout_5->setContentsMargins(0, 0, 0, 0);
        change_2 = new QPushButton(layoutWidget_2);
        ...
        change_exit = new QPushButton(layoutWidget_2);
