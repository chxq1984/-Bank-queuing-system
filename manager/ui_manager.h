...
**
** Created: Sun Jul 14 21:05:06 2019
...
public:
    ...
    void setupUi(QDialog *manager)
    {
        ...
        label->setGeometry(QRect(-10, -10, 411, 311));
        textBrowser = new QTextBrowser(manager);
        textBrowser->setObjectName(QString::fromUtf8("textBrowser"));
        textBrowser->setGeometry(QRect(100, 80, 231, 141));
        textBrowser->setStyleSheet(QString::fromUtf8("font: 75 18pt \"Bitstream Charter\";\n"
"color: rgb(0, 85, 255);"));
